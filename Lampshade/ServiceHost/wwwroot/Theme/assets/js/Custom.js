        ...
        let product = `<div class="single-cart-item">
                            <div class="image">
                                <a href="single-product.html">
                                    <img src="/ProductPictures/avatar.png"
                                         class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="content">
                                <p class="product-title">
                                    <a>نام محصول: ${x.name}</a>
                                </p>
                              ...
                              <br/>
                            <a class="text-danger" onclick="removeFromCart('${x.id}')">
                             <i class="fa fa-trash fa-2x"></i>
                            </a>
                              <a class="btn btn-rounded btn-primary MarginCart" href="/ShoppingCart">مشاهده سبد خرید</a>
                           <hr/>`;
